...
import {
  ...
  DirectionalLight,
  Mesh,
  MeshStandardMaterial, PCFShadowMap, PerspectiveCamera, ReinhardToneMapping,
  Scene,
  sRGBEncoding,
  TextureLoader, Vector3, WebGLRenderer, WebGLRenderTarget
} from 'three';
...
const renderTarget = new WebGLRenderTarget(
  ...
  600,
  {
    samples: renderer.getPixelRatio() === 1 ? 2 : 0 // samples is a WebGL2 property. It won't change anything in old browser
  }
);
