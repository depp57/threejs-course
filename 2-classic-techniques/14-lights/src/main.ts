...
const directionalLight = new DirectionalLight(0x00fffc, .3);
...
const pointLight      = new PointLight(0xff9000, 1, 2, 2);
pointLight.position.y = 1;
// scene.add(pointLight);

const rectAreaLight = new RectAreaLight(0x4e00ff, 10, 2, 1);
rectAreaLight.position.set(0, 0, 1);
rectAreaLight.lookAt(new Vector3());
scene.add(rectAreaLight);

const spotLight = new SpotLight(0x78ff00, .5, 7, Math.PI * .1, .3, 1);
